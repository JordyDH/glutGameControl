...
void toetsen( unsigned char key, int x, int y)
{
	...
	switch ( key )
	{
		//case 'z' : moveCamera(0,0,2);break;
		//case 's' : moveCamera(0,0,-2);break;
		//case 'q' : moveCamera(-2,0,0);break;
		//case 'd' : moveCamera(2,0,0);break;
...
void kubus(void)
{
	...
	//gluLookAt(xPos,yPos,zPos, xPos+xl,yPos+yl,zPos+zl, xvw, yvw, zvw);
